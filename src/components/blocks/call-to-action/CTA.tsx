    ...
    return (
        ...
        >
            <div className="container">
                <div className="row">
                    <div className="py-15 col-lg-6 col-xl-5 mx-auto">
                        <h2 className="display-4 mb-3 text-center">Want to attend?</h2>

                        <p className="lead mb-5 px-md-16 px-lg-3">
                            Register now to attend the International Elecotral Awards & Symposium to recognise excelence in electoral management and connect with electoral professionals from around the globe.
                        </p>
