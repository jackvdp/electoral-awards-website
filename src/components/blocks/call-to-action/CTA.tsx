                ...
                <div className="row">
                    <div className="py-18 col-lg-6 col-xl-5 mx-auto">
                        ...
                        <p className="lead mb-5 px-md-16 px-lg-3">
                            Register now to attend the International Electoral Awards & Symposium to recognise excelence in electoral management and connect with electoral professionals from around the globe.
                        </p>
