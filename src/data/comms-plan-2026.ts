...
export const commsPlan2026: CommsPlanData = {
    ...
    emails: [
        ...
        },
        {
            ...
            primary: 'Webinar invitation: The Intelligence Edge — 4 June',
            secondary: 'Nominations reminder; register for Manila',
            subject: 'Join us — The Intelligence Edge: Managing the Electoral Information Environment | 4 June',
            cta: 'Register for webinar',
        ...
        },
        {
            ...
            secondary: 'Nominations progress; Intelligence Edge webinar — 4 June',
            subject: 'Symposium themes announced — shape the conversation',
            cta: 'Register now',
            audience: 'Full database.',
            detail: 'Announce 3–4 symposium themes/tracks. "This is what you\'ll learn and discuss." Share nominations progress. Reminder: The Intelligence Edge webinar is coming up on 4 June — register if you haven\'t already.',
            status: 'pending',
            tags: ['programme', 'nominations', 'registration', 'webinars'],
        },
        {
            id: 8, wc: '18 May', weekStart: '2026-05-18', phase: 2,
            primary: 'Intelligence Edge — two weeks to go',
            secondary: 'Nominations (3 months left); register for Manila',
            subject: 'Two weeks — The Intelligence Edge | 4 June, 14:00 UTC',
            cta: 'Register for webinar',
            audience: 'Full database (priority: non-registrants for webinar).',
            detail: 'Advance notice for The Intelligence Edge webinar (4 June, 14:00 UTC). Short preview of the agenda and what to expect. "Two weeks to go — and join delegates from around the world in Manila this November. Three months left to register, free of charge."',
            status: 'pending',
        ...
        },
        {
            ...
            secondary: 'Intelligence Edge next week (4 Jun); nominations reminder',
            subject: 'First speakers confirmed — 22nd Electoral Awards',
            cta: 'Register to attend',
            audience: 'Full database.',
            detail: 'First confirmed speakers (2–3 names, titles, topics). Build programme credibility. "Three months left to nominate." Reminder: The Intelligence Edge webinar is next week — 4 June, 14:00 UTC. Register now.',
            status: 'pending',
        ...
        },
        {
            ...
            subject: 'This Thursday — The Intelligence Edge | 4 June, 14:00 UTC',
            cta: 'Register for webinar',
            audience: 'Full database (priority: non-registrants for webinar).',
            detail: 'Final reminder for The Intelligence Edge webinar (4 June, 14:00 UTC). Last chance to register. "Join us this Thursday — and join delegates from around the world in Manila this November."',
            status: 'pending',
            tags: ['webinars'],
        },
        {
            id: 11, wc: '8 Jun', weekStart: '2026-06-08', phase: 2,
            primary: 'Category spotlight (remaining categories)',
            secondary: 'Intelligence Edge recap; nominations reminder',
    ...
    socialPosts: [
        ...
        { wc: '18 May', weekStart: '2026-05-18', count: 2, description: 'Webinar 2 promo — The Intelligence Edge (4 Jun), topic preview and sign-up reminder' },
        { wc: '25 May', weekStart: '2026-05-25', count: 3, description: 'Speaker reveals with headshots and quotes; Intelligence Edge final reminder (next week)' },
        { wc: '1 Jun', weekStart: '2026-06-01', count: 2, description: 'Intelligence Edge final push — this Thursday, 14:00 UTC' },
        { wc: '8 Jun', weekStart: '2026-06-08', count: 3, description: 'Category deep-dive, nomination reminder, Intelligence Edge recap graphic' },
        { wc: '15 Jun', weekStart: '2026-06-15', count: 2, description: 'Partnership Campaign 1 — awareness post; Webinar 2 recap: The Intelligence Edge key insights' },
    ...
    notes: [
        ...
        '2026 webinar programme: Webinar 1 — Empowering the Election Workforce (24 Apr) | Webinar 2 — The Intelligence Edge (4 Jun) | Webinar 3 — Speed in Election Results Transmission (14 Jul) | Webinar 4 — Inclusive Elections (16 Sep).',
