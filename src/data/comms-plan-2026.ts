...
export const commsPlan2026: CommsPlanData = {
    ...
    emails: [
        ...
        },
        {
            ...
            secondary: 'Workforce webinar recap; save the date — Knowledge Sharing webinar (4 Jun)',
            subject: 'Which category fits your initiative?',
            cta: 'Submit a nomination / Register',
            audience: 'Full database (emphasis on EMBs who haven\'t nominated).',
            detail: 'Deep-dive on 3–4 award categories with criteria and past winner examples. Help contacts identify the right category. Include a short recap of the Workforce webinar — key takeaways and link to recording. Save the date teaser: Strengthening the Electoral Profession webinar on 4 June.',
            status: 'pending',
        ...
        },
        {
            ...
            secondary: 'Nominations progress; Knowledge Sharing webinar — 4 June',
            subject: 'Symposium themes announced — shape the conversation',
            cta: 'Register now',
            audience: 'Full database.',
            detail: 'Announce 3–4 symposium themes/tracks. "This is what you\'ll learn and discuss." Share nominations progress. Reminder: the Knowledge Sharing webinar is coming up on 4 June — register if you haven\'t already.',
            status: 'pending',
            tags: ['programme', 'nominations', 'registration', 'webinars'],
        },
        {
            id: 8, wc: '18 May', weekStart: '2026-05-18', phase: 2,
            primary: 'Knowledge Sharing webinar — two weeks to go',
            secondary: 'Nominations (3 months left); register for Manila',
            subject: 'Two weeks — Strengthening the Electoral Profession | 4 June, 14:00 UTC',
            cta: 'Register for webinar',
            audience: 'Full database (priority: non-registrants for webinar).',
            detail: 'Advance notice for the Knowledge Sharing webinar (4 June, 14:00 UTC). Short preview of the agenda and what to expect. "Two weeks to go — and join delegates from around the world in Manila this November. Three months left to register, free of charge."',
            status: 'pending',
