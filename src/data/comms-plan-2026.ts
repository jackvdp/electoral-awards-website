...
export const commsPlan2026: CommsPlanData = {
    ...
    keyDates: [
        ...
        { label: 'Webinar 2', position: (2 + 4.5 / 5) / 9, colour: '#e8a317' },
    ...
    emails: [
        ...
        },
        {
            ...
            detail: 'Announce the full 2026 programme: the 22nd International Electoral Awards in Manila (29 Nov – 3 Dec), plus four webinars — Empowering the Election Workforce (17 Apr), The Intelligence Edge (28 May), Speed in Election Results Transmission (14 Jul), and Inclusive Elections (16 Sep). Recap 2025 highlights and set the tone for the year. Soft tease that nominations open in April.',
            status: 'drafted',
        ...
        {
            id: 4, wc: '20 Apr', weekStart: '2026-04-20', phase: 1,
            ...
            audience: 'Full database.',
            detail: 'Explain the 8 categories, the process, the deadline (31 August). "Haven\'t registered yet? Attendance is free and accommodation at The Manila Hotel is covered." Reminder: Workforce webinar this Friday (24 April) — last chance to sign up.',
            status: 'pending',
        ...
        },
        {
            ...
            secondary: 'Workforce webinar recap; save the date — The Intelligence Edge (28 May)',
            subject: 'Which category fits your initiative?',
            cta: 'Submit a nomination / Register',
            audience: 'Full database (emphasis on EMBs who haven\'t nominated).',
            detail: 'Deep-dive on 3–4 award categories with criteria and past winner examples. Help contacts identify the right category. Include a short recap of the Workforce webinar — key takeaways and link to recording. Save the date teaser: The Intelligence Edge webinar on 28 May.',
            status: 'pending',
            tags: ['nominations', 'webinars'],
        },
        {
            id: 6, wc: '4 May', weekStart: '2026-05-04', phase: 2,
            primary: 'Webinar invitation: The Intelligence Edge — 28 May',
            secondary: 'Nominations reminder; register for Manila',
            subject: 'Join us — The Intelligence Edge: Managing the Electoral Information Environment | 28 May',
            cta: 'Register for webinar',
            audience: 'Full database, including expanded managerial-tier contacts.',
            detail: 'Dedicated invitation for The Intelligence Edge webinar (28 May, 14:00 UTC). Electoral bodies today must navigate a 24/7 news cycle — tracking legislative changes, monitoring media, identifying disinformation, and staying ahead of the information environment. This webinar explores how EMBs can build structured intelligence-gathering practices to improve decision-making, resilience, and public communication. Speakers to be confirmed. "Three months left to register for Manila — free, with accommodation provided."',
            status: 'pending',
            tags: ['webinars'],
        },
        {
            ...
            secondary: 'Nominations progress; Intelligence Edge webinar — 28 May',
            subject: 'Symposium themes announced — shape the conversation',
            cta: 'Register now',
            audience: 'Full database.',
            detail: 'Announce 3–4 symposium themes/tracks. "This is what you\'ll learn and discuss." Share nominations progress. Reminder: The Intelligence Edge webinar is coming up on 28 May — register if you haven\'t already.',
            status: 'pending',
            tags: ['programme', 'nominations', 'registration', 'webinars'],
        },
        {
            id: 8, wc: '18 May', weekStart: '2026-05-18', phase: 2,
            primary: 'Final reminder: The Intelligence Edge — this Thursday',
            secondary: 'Nominations (3 months left); register for Manila',
            subject: 'This Thursday — The Intelligence Edge | 28 May, 14:00 UTC',
            cta: 'Register for webinar',
            audience: 'Full database (priority: non-registrants for webinar).',
            detail: 'Final reminder for The Intelligence Edge webinar (28 May, 14:00 UTC). Last chance to register. Short preview of the agenda and what to expect from the discussion. "Join us this Thursday — and join delegates from around the world in Manila this November. Three months left to register, free of charge."',
            status: 'pending',
        ...
        },
        {
            ...
            secondary: 'Upcoming webinar (14 Jul); nominations reminder',
            subject: 'First speakers confirmed — 22nd Electoral Awards',
            cta: 'Register to attend',
            audience: 'Full database.',
            detail: 'First confirmed speakers (2–3 names, titles, topics). Build programme credibility. "Three months left to nominate." Upcoming: Speed in Election Results Transmission webinar on 14 July — sign up now.',
            status: 'pending',
            tags: ['speakers', 'nominations', 'registration', 'webinars'],
        },
        {
            id: 10, wc: '8 Jun', weekStart: '2026-06-08', phase: 2,
            primary: 'Category spotlight (remaining categories)',
            secondary: 'Intelligence Edge recap; registration milestone',
            subject: 'Award categories in focus — could your work be recognised?',
            cta: 'Submit a nomination / Register',
            audience: 'Full database (emphasis on non-nominators).',
            detail: 'Spotlight remaining award categories not covered in Email 5. Past winner testimonials or case study excerpts. Short recap of The Intelligence Edge webinar — key takeaways and link to recording for those who missed it. Upcoming: Speed in Election Results Transmission webinar on 14 July.',
            status: 'pending',
            tags: ['nominations', 'speakers', 'webinars'],
        },
        {
            id: 11, wc: '22 Jun', weekStart: '2026-06-22', phase: 2,
        ...
        {
            id: 12, wc: '6 Jul', weekStart: '2026-07-06', phase: 3,
        ...
        {
            id: 13, wc: '20 Jul', weekStart: '2026-07-20', phase: 3,
        ...
        {
            id: 14, wc: '3 Aug', weekStart: '2026-08-03', phase: 3,
        ...
        {
            id: 15, wc: '17 Aug', weekStart: '2026-08-17', phase: 3,
        ...
        {
            id: 16, wc: '25 Aug', weekStart: '2026-08-25', phase: 3,
        ...
        {
            id: 17, wc: '31 Aug', weekStart: '2026-08-31', phase: 3,
        ...
        {
            id: 18, wc: '7 Sep', weekStart: '2026-09-07', phase: 4,
        ...
        {
            id: 19, wc: '14 Sep', weekStart: '2026-09-14', phase: 4,
        ...
        {
            id: 20, wc: '28 Sep', weekStart: '2026-09-28', phase: 4,
        ...
        {
            id: 21, wc: '12 Oct', weekStart: '2026-10-12', phase: 4,
        ...
        {
            id: 22, wc: '26 Oct', weekStart: '2026-10-26', phase: 5,
        ...
        {
            id: 23, wc: '9 Nov', weekStart: '2026-11-09', phase: 5,
        ...
        {
            id: 24, wc: '23 Nov', weekStart: '2026-11-23', phase: 5,
    ...
    socialPosts: [
        ...
        { wc: '18 May', weekStart: '2026-05-18', count: 2, description: 'Webinar 2 promo — The Intelligence Edge (28 May), topic preview and sign-up reminder' },
        { wc: '25 May', weekStart: '2026-05-25', count: 3, description: 'Speaker reveals with headshots and quotes' },
        { wc: '8 Jun', weekStart: '2026-06-08', count: 3, description: 'Category deep-dive, nomination reminder, Intelligence Edge recap graphic' },
        { wc: '15 Jun', weekStart: '2026-06-15', count: 2, description: 'Webinar 2 recap — The Intelligence Edge key insights graphic, link to recording' },
        ...
        { wc: '21 Sep', weekStart: '2026-09-21', count: 2, description: 'Webinar 4 recap — key takeaways graphic, link to recording' },
    ...
    notes: [
        ...
        '2026 webinar programme: Webinar 1 — Empowering the Election Workforce (24 Apr) | Webinar 2 — The Intelligence Edge (28 May) | Webinar 3 — Speed in Election Results Transmission (14 Jul) | Webinar 4 — Inclusive Elections (16 Sep).',
    ],
};
