...
export const schedule: Day[] = [
    {
        title: "Day 1 — Arrival of Delegates & Welcome Dinner",
        events: [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "10:30 – 11:30", description: "<p><strong>\"Trust‑Building and Integrity in Emerging Democracies in Electoral Management\"</strong> - Hon Justice Gaolapelwe Ketlogetswe, Chief Justice, Botswana</p>" },
            { time: "11:45 – 12:15", description: "<p><strong>Morning Panel — \"Botswana 2024: Good Practices, Opportunities & Challenges\"</strong></p><p>Session Moderator – Commissioner Wame T. Thanke, IEC, Botswana</p><ul><li>Speaker 1: Jeff Siamisang, SIEC - Review of 2024 General Elections of Botswana: Perspectives from Election Management Body – Independent Electoral Commission of Botswana</li></ul>" },
            { time: "12:30 – 13:45", description: "<p>Lunch</p>" },
            { time: "14:00 – 14:30", description: "<p><strong>Keynote — \"Designing Inclusive Electoral Frameworks: Gender, Youth & Disability\"</strong></p><p>**TBC**</p>" },
            { time: "14:45 – 15:45", description: "<p><strong>Afternoon Panel — \"From Access to Influence: Making Elections Truly Inclusive\"</strong></p><ol><li>Misheck Gondo – South Africa Youth Forum</li><li>Zvanguwo Sachikonye – Professor of Political Science based at the University of Zimbabwe</li><li>Industry Voice</li></ol>" },
