...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "1245h-1315h", description: "<p><strong>Keynote Presentation:</strong> TBC</p>" },
            { time: "1330-1400h", description: "<p><strong>Industry Presentation:</strong> Neurotechnology</p>" },
            { time: "1400h", description: "<p>Symposium Closing</p>" },
            { time: "1400h", description: "<p>Lunch at Hotel</p>" },
            { time: "1500h", description: "<p>Rest and/or explore places of interest nearby before the start of the Awards Ceremony</p>" },
