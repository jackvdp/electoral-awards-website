...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "1545h-1615h", description: "<p><strong>Keynote Presentation:</strong> Disinformation & Artificial Intellgience</p><ul><li>Olga Mariela Quintanar Sosa, The Electoral Tribunal of the Federal Judiciary of Mexico (TEPJF)</li></ul>" },
