...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "1230h-1300h", description: "<p><strong>Keynote Presentation:</strong> Do voter information campaigns make a difference?</p><ul><li>Professor Daniel Stockemer, University of Ottawa</li></ul>" },
            { time: "1315h-1345h", description: "<p><strong>Industry Presentation:</strong> Neurotechnology</p>" },
            { time: "1345h", description: "<p>Symposium Closing</p>" },
            { time: "1030h-1400h", description: "<p><strong>Fringe Events:</strong> Industry demonstrations</p>" },
            { time: "1400h", description: "<p>Lunch at Hotel</p>" },
            { time: "1400h", description: "<p>Rest and/or explore places of interest nearby before the start of the Awards Ceremony</p>" },
