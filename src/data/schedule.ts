...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "14:45 – 15:45", description: "<p><strong>Afternoon Panel — \"From Access to Influence: Making Elections Truly Inclusive\"</strong></p><ol><li>Melatwork Hailu – Chairperson of the National Election Board of Ethiopia</li><li>Helen G. Aguila-Flores, Commission on Elections Philippines</li><li>Industry Voice</li></ol>" },
