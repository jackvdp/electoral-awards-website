...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "1000h-1030h", description: "<p><strong>Keynote Presentation:</strong> 2024 US Election & Beyond: the Role of the EAC</p><ul><li>Thomas Hicks, US Election Assistance Commission</li></ul>" },
