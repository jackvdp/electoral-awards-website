...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "1245h-1315h", description: "<p><strong>Keynote Presentation</strong></p><ul><li>Thomas Hicks, US Election Assistance Commission</li></ul>" },
