...
export const schedule: Day[] = [
    ...
    },
    {
        ...
        events: [
            ...
            { time: "14:45 – 15:45", description: "<p><strong>Afternoon Panel — \"From Access to Influence: Making Elections Truly Inclusive\"</strong></p><ol><li>Melatwork Hailu – Chairperson of the National Election Board of Ethiopia</li><li>Ms K. Molatlhwa – Botswana Coalition of Non-Governmental Organisations (BOCONGO)</li><li>Executive Director, Federation of Disabled People's Organisations – Botswana</li><li>Ms Pamela Dube – Gender Links</li><li>Industry Voice</li></ol>" },
