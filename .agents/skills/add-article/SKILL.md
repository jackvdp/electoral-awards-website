...
```bash
ARTICLE_JSON='{ "title": "...", "link": "...", "image": "...", "category": "...", "description": "...", "content": "..." }' node .agents/skills/add-article/seed-article.mjs
```
...
```bash
ARTICLE_JSON="$(cat /tmp/article.json)" node .agents/skills/add-article/seed-article.mjs
```
