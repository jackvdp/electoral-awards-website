...
```bash
ARTICLE_JSON='{ "title": "...", "link": "...", "image": "...", "category": "...", "description": "...", "content": "..." }' node .Codex/skills/add-article/seed-article.mjs
```
...
```bash
ARTICLE_JSON="$(cat /tmp/article.json)" node .Codex/skills/add-article/seed-article.mjs
```
