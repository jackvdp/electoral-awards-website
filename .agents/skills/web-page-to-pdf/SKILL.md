...
```bash
.agents/skills/web-page-to-pdf/html-to-pdf.sh INPUT.html [OUTPUT.pdf]
```
...
```bash
.agents/skills/web-page-to-pdf/html-to-pdf.sh # (edit the command to use the URL in place of file://)
...
3. **Converted with headless Chrome:**
   ...
   ```
   (Equivalently: `.agents/skills/web-page-to-pdf/html-to-pdf.sh projects/nomos/partnership-plan/NOMOS-ICPS-Partnership-Plan-2026-updated.html`)
