...
export const commsPlan2026: CommsPlanData = {
    ...
    emails: [
        ...
        },
        {
            ...
            primary: 'Partnership Campaign 3 — thought partners',
            ...
            detail: 'Recruits a small number of organisations and academics as NOMOS thought partners: share published work with the Network at no cost, with output fed through automatically, plus an option to write for members against the annual editorial schedule. Makes clear NOMOS is not a marketplace and thought partners are not sponsors. Two versions differ only in the hook so one variable is tested: A leads on reach, B on the funding squeeze. Everything else is identical. Copy agreed with Sean Evins and Charles Symons (NOMOS/Buzzmint) — Sean confirmed the language 16 Aug 2026; Tracy prefers version A. Followed up by a senior ICPS operative, with detailed feedback captured from the calls. Version B template: 2026-08-email-18-partnership-campaign-3-version-b.eml. Two dependencies before sending: the annual editorial schedule must exist (both versions reference it), and the recipient list is still being settled with Sean. Moved from w/c 10 August to w/c 17 August (17 Aug 2026).',
            status: 'drafted',
            tags: ['partnership'],
