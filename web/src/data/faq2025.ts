export const FAQs = [
  {
    ...
    body: `The 21st International Electoral Awards will be held on Wednesday 1st October 2025. This will be the main event of a four-day programme running from 1st–4th October. For a full schedule, please see [here](/awards/2025/schedule).`
  },
  {
    no: 'Two',
    expand: true,
