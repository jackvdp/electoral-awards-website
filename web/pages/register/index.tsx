...
const RegisterPage: NextPage = () => {
    ...
    return (
        <Fragment>
            <CustomHead
                title="Register"
                description="Join the Electoral Members' Network. Create an account to connect with electoral professionals, access exclusive resources, and participate in our global community."
            />
            <PageProgress/>
