...
const AccountPage: NextPage<AccountPageProps> = ({user}) => {
    ...
    return (
        <Fragment>
            <CustomHead
                title="Account"
                description="Manage your Electoral Members' Network profile, update your professional information, and customize your network preferences and notifications."
            />
            <PageProgress/>
